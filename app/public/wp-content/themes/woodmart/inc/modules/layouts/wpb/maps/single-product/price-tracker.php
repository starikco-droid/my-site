		...
		return array(
			...
			'params'      => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-pt-btn > a span' => array(
							'color: {{VALUE}};',
						),
					),
					'dependency'       => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-pt-btn > a:hover span' => array(
							'color: {{VALUE}};',
						),
					),
					'dependency'       => array(
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .wd-pt-btn[class*="wd-style-"]' => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-pt-btn > a:before' => array(
							'color: {{VALUE}};',
						),
					),
					'edit_field_class' => 'vc_col-sm-6 vc_column',
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-pt-btn > a:hover:before' => array(
							'color: {{VALUE}};',
						),
					),
					'edit_field_class' => 'vc_col-sm-6 vc_column',
