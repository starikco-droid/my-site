...
class Dashboard extends Singleton {
	...
	public function add_pages_to_admin_bar_menu( $admin_bar ) {
		...
		$admin_bar->add_node(
			array(
				'id'     => 'xts_popup_builder_add',
				'title'  => esc_html__( 'Add new', 'woodmart' ),
				'href'   => admin_url( 'post-new.php?post_type=wd_popup' ),
				'parent' => 'xts_popup_builder',
				'meta'   => array(
					'title' => esc_html__( 'Add new', 'woodmart' ),
				),
		...
		$admin_bar->add_node(
			array(
				...
				'title'  => esc_html__( 'Add new', 'woodmart' ),
				'href'   => admin_url( 'post-new.php?post_type=wd_floating_block' ),
				'parent' => 'xts_floating_blocks',
				'meta'   => array(
					'title' => esc_html__( 'Add new', 'woodmart' ),
				),
