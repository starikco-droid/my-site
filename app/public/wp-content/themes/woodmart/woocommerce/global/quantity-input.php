...
<div class="quantity<?php echo 'hidden' === $type ? ' hidden' : ''; ?>">
	...
	<?php if ( 'number' === $type ) : ?>
		<input type="button" value="-" class="minus btn" aria-label="<?php esc_attr_e( 'Decreace quantity', 'woocommerce' ); ?>" />
	<?php endif; ?>
	...
	<?php if ( 'number' === $type ) : ?>
		<input type="button" value="+" class="plus btn" aria-label="<?php esc_attr_e( 'Increace quantity', 'woocommerce' ); ?>" />
	<?php endif; ?>
