	...
	<div class="options_group hide_if_grouped">
		<table class="form-table" style="max-width:none;">
						...
						<div class="form-field">
							...
							<div class="switcher-target-payment_method" style="margin-top:10px;">
								<span class="wpallimport-slide-content" style="padding-left:0;">
									...
									<a href="#help" class="wpallimport-help" title="<?php printf(__('Payment method can be matched by title or slug: %s. If payment method is not found \'N/A\' will be applied to order.', 'wpai_woocommerce_addon_plugin'), implode(", ", $payment_gateways_for_tooltip)); ?>" style="position:relative; top:12px;left:8px;">?</a>
								</span>
							</div>
						</div>
					</div>
            ...
            <tr>
                <td>
                    <div class="form-field">
                        <p class="form-field"><?php _e('Payment Date', 'wpai_woocommerce_addon_plugin'); ?></p>
                        <div class="form-field">
                            <div class="date">
            ...
            <tr>
				<td>
					<div class="form-field">
                        <p class="form-field"><?php _e('Transaction ID', 'wpai_woocommerce_addon_plugin'); ?></p>
						<div class="form-field">
							<div class="clear">
