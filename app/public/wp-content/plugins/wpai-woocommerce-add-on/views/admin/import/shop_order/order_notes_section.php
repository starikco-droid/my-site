					...
					<tr>
						<td>
							...
							<!-- <div class="form-field wpallimport-radio-field wpallimport-clear">
								...
								<label for="notes_repeater_mode_fixed" style="width:auto;"><?php _e('Fixed Repeater Mode', 'wpai_woocommerce_addon_plugin') ?></label>
							</div> -->	
							<table class="form-field wpallimport_variable_table order-notes" style="width:98%;">
									...
									<tr class="form-field">
										<td>
											<table style="width:100%;" cellspacing="5">
												<tr>
													<td colspan="2">
														<h4 style="margin-top:0;"><?php _e('Content', 'wpai_woocommerce_addon_plugin') ?></h4>
														<div class="input">
												...
												<tr>
													<td colspan="2">
														<h4><?php _e('Date', 'wpai_woocommerce_addon_plugin') ?><a href="#help" class="wpallimport-help" style="position:relative;top:-1px;left:6px;" title="<?php _e('Use any format supported by the PHP <b>strtotime</b> function. That means pretty much any human-readable date will work.', 'wpai_woocommerce_addon_plugin') ?>">?</a></h4>
														<div class="input">
												...
												<tr>
													<td colspan="2">
														<h4><?php _e('Visibility', 'wpai_woocommerce_addon_plugin') ?></h4>
														<div class="form-field wpallimport-radio-field">
															...
															<label for="order_note_visibility_privat_<?php echo $i; ?>" style="width:auto;"><?php _e('Private note', 'wpai_woocommerce_addon_plugin') ?></label>
														</div>
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibility_customer_<?php echo $i; ?>" style="width:auto;"><?php _e('Note to customer', 'wpai_woocommerce_addon_plugin') ?></label>
														</div>							
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibilityy_xpath_<?php echo $i; ?>" style="width:auto;"><?php _e('Set with XPath', 'wpai_woocommerce_addon_plugin') ?></label>
														</div>	
														...
														<div class="switcher-target-order_note_visibilityy_xpath_<?php echo $i; ?>">										
															<span class="wpallimport-slide-content" style="padding-left:0;">
																...
																<a href="#help" class="wpallimport-help" title="<?php _e('Use \'private\' or \'customer\'.', 'wpai_woocommerce_addon_plugin') ?>" style="position:relative; top:-2px;left:4px;">?</a>
															</span>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<label><?php _e('Username', 'wpai_woocommerce_addon_plugin'); ?></label>
														<div class="clear">
								...
								<tr class="form-field template">
									<td>
										<table style="width:100%;" cellspacing="5">
												...
												<td colspan="2">
													...
													<div class="input">
														<div class="form-field wpallimport-radio-field">
															...
															<label for="order_note_visibility_privat_ROWNUMBER" style="width:auto;"><?php _e('Private note', 'wpai_woocommerce_addon_plugin') ?></label>
														</div>													
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibility_customer_ROWNUMBER" style="width:auto;"><?php _e('Note to customer', 'wpai_woocommerce_addon_plugin') ?></label>
														</div>																				
														<div class="form-field wpallimport-radio-field clear">
															...
															<label for="order_note_visibilityy_xpath_ROWNUMBER" style="width:auto;"><?php _e('Set with XPath', 'wpai_woocommerce_addon_plugin') ?></label>
														</div>	
														<span class="wpallimport-clear"></span>
											...
											<tr>
												<td>
													<h4><?php _e('Username', 'wpai_woocommerce_addon_plugin'); ?></h4>
													<div class="clear">
														<input type="text" name="pmwi_order[notes][ROWNUMBER][username]" value="" style="width:100%;"/>	
													</div>
												</td>
												<td>
													<h4><?php _e('Email', 'wpai_woocommerce_addon_plugin'); ?></h4>
													<div class="clear">
								...
								<tr class="wpallimport-row-actions" style="display:none;">
									<td colspan="2">					
										<a class="add-new-line" title="Add Another Note" href="javascript:void(0);" style="width:200px;"><?php _e("Add Another Note", 'wpai_woocommerce_addon_plugin'); ?></a>
									</td>
								</tr>
							</table>							
						</td>
			...
			<div class="wpallimport-collapsed closed wpallimport-section">
				<div style="margin:0; border-top:1px solid #ddd; border-bottom: none; border-right: none; border-left: none; background: #f1f2f2;" class="wpallimport-content-section rad0">
					<div class="wpallimport-collapsed-header">
						<h3 style="color:#40acad;"><?php _e("Advanced Options", 'wpai_woocommerce_addon_plugin');?></h3>
					</div>
					<div style="padding: 0px;" class="wpallimport-collapsed-content">										
						<div class="wpallimport-collapsed-content-inner">											
							...
							<div class="form-field wpallimport-radio-field wpallimport-clear pmxi_option">
								...
								<label for="notes_repeater_mode_variable_csv" style="width:auto;"><?php _e('Fixed Repeater Mode', 'wpai_woocommerce_addon_plugin') ?></label>
								<div class="switcher-target-notes_repeater_mode_variable_csv wpallimport-clear" style="padding: 10px 0 10px 25px; overflow: hidden;">
									<span class="order-separator-label wpallimport-slide-content" style="padding-left:0;">	
										<label><?php _e('Multiple notes separated by', 'wpai_woocommerce_addon_plugin'); ?></label>
							...
							<div class="form-field wpallimport-radio-field wpallimport-clear pmxi_option">
								...
								<label for="notes_repeater_mode_variable_xml" style="width:auto;"><?php _e('Variable Repeater Mode', 'wpai_woocommerce_addon_plugin') ?></label>
								<div class="switcher-target-notes_repeater_mode_variable_xml wpallimport-clear" style="padding: 10px 0 10px 25px; overflow: hidden;">
									<span class="wpallimport-slide-content" style="padding-left:0;">	
										<label style="width: 60px;"><?php _e('For each', 'wpai_woocommerce_addon_plugin'); ?></label>
										...
										<label style="padding-left: 10px;"><?php _e('do...', 'wpai_woocommerce_addon_plugin'); ?></label>
									</span>
								</div>		
							</div>	
							<?php else: ?>
							...
							<div class="form-field input" style="padding-left: 20px;">
								<label class="order-separator-label" style="line-height: 30px;"><?php _e('Multiple notes separated by', 'wpai_woocommerce_addon_plugin'); ?></label>
                            ...
                            <div class="form-field input" style="padding-left: 5px;padding-top: 25px;">
                                ...
                                <label for="pmwi_order[notes_add_auto_order_status_notes]" class="order-separator-label" style="line-height: 30px;"><?php _e('Allow automatic order status change notes', 'wpai_woocommerce_addon_plugin'); ?></label>
