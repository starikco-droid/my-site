	...
	<div class="options_group hide_if_grouped">
		<div class="input">
			<div class="form-field wpallimport-radio-field">
				...
				<label for="shipping_source_copy" style="width:auto;"><?php _e('Copy from billing', 'wpai_woocommerce_addon_plugin') ?></label>
			</div>
		</div>
		<div class="clear"></div>
		<div style="margin-top:0; padding-left:8px;">
			<div class="form-field wpallimport-radio-field">
				...
				<label for="shipping_source_guest" style="width:auto;"><?php _e('Import shipping address', 'wpai_woocommerce_addon_plugin') ?></label>
			</div>
			...
			<div class="switcher-target-shipping_source_guest" style="padding-left:45px;">
				<span class="wpallimport-slide-content" style="padding-left:0;">
					<div class="form-field wpallimport-radio-field" style="padding-left: 3px;">
						...
						<label for="shipping_copy_from_billing" style="width:auto;"><?php _e('If order has no shipping info, copy from billing', 'wpai_woocommerce_addon_plugin') ?></label>
					</div>
		...
		<div class="input">
			<div class="form-field">
				<label><?php _e('Customer Provided Note', 'wpai_woocommerce_addon_plugin'); ?></label>
