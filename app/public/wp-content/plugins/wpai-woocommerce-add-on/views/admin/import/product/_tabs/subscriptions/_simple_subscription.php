<div class="options_group show_if_subscription show_if_variable_subscription">
    <p class="form-field">
        <label><?php printf(__("Subscription price (%s)", 'wpai_woocommerce_addon_plugin'), get_woocommerce_currency_symbol()); ?></label>
        <input type="text" class="short" name="single_product_subscription_price" value="<?php echo esc_attr($post['single_product_subscription_price']) ?>"/> <strong class="options_group" style="position:relative; top:4px; left:4px;">(<?php _e('required', 'wpai_woocommerce_addon_plugin'); ?>)</strong>
    </p>
    <span class="wpallimport-clear"></span>
    <div class="subscription-billing-settings">
        <p class="form-field woocommerce-group-label"><?php _e("Billing interval", 'wpai_woocommerce_addon_plugin'); ?><a href="#help" class="wpallimport-help" style="top: 0;" title="<?php _e('Set how much time between each renewal for recurring billing schedules.', 'wpai_woocommerce_addon_plugin') ?>">?</a></p>
        <div class="subscription-billing-interval">
            ...
            <div class="form-field wpallimport-radio-field">
                ...
                <label for="multiple_product_subscription_period_interval_no"><?php _e('Set with XPath', 'wpai_woocommerce_addon_plugin' ); ?><a href="#help" class="wpallimport-help" style="top: 0;" title="<?php _e('Return a number from 1 to 6.', 'wpai_woocommerce_addon_plugin') ?>">?</a></label>
                <span class="wpallimport-clear"></span>
        ...
        <div class="subscription-billing-period">
            ...
            <div class="form-field wpallimport-radio-field">
                ...
                <label for="multiple_product_subscription_period_no"><?php _e('Set with XPath', 'wpai_woocommerce_addon_plugin' ); ?><a href="#help" class="wpallimport-help" style="top: 0;" title="<?php _e('Return one of the following: day, week, month, year.', 'wpai_woocommerce_addon_plugin') ?>">?</a></label>
                <span class="wpallimport-clear"></span>
        ...
        <div class="form-field wpallimport-radio-field">
            ...
            <?php foreach ( $intervals as $group => $options ) { ?>
                <select class="subscription_length-<?php echo $group;?>" style="display: none;">
                    <option value="0" <?php selected( 0, $post['multiple_product_subscription_length'], true ) ?>><?php _e('Never expire', 'wpai_woocommerce_addon_plugin'); ?></option>
    ...
    <hr>
    <p class="form-field">
        <label><?php printf(__("Sign-up fee (%s)", 'wpai_woocommerce_addon_plugin'), get_woocommerce_currency_symbol()); ?></label>
    ...
    <div class="subscription-trial">
        ...
        <div class="form-field wpallimport-radio-field">
            ...
            <select class="select short" name="multiple_product_subscription_trial_period">
                <option value="0" <?php selected( 0, $post['multiple_product_subscription_trial_period'], true ) ?>><?php _e('No free trial', 'wpai_woocommerce_addon_plugin'); ?></option>
                <?php foreach ( $intervals as $group => $options ) { ?>
                    <optgroup label="<?php echo $group;?>">
                        <?php foreach ( $options as $value => $label ) { ?>
                            <?php if (!empty($value)): ?>
        ...
        <div class="form-field wpallimport-radio-field">
            ...
            <label for="multiple_product_subscription_trial_period_no"><?php _e('Set with XPath', 'wpai_woocommerce_addon_plugin' ); ?><a href="#help" class="wpallimport-help" style="top: 0;" title="<?php _e('Return a value matching one of the options in the pulldown: 1 week, 2 months, etc.', 'wpai_woocommerce_addon_plugin') ?>">?</a></label>
            <span class="wpallimport-clear"></span>
